...
def constructor_stock():
    client = MongoClient("mongodb://ms0075415:E224501001@ac-elfhgej-shard-00-00.ymufszp.mongodb.net:27017,ac-elfhgej-shard-00-01.ymufszp.mongodb.net:27017,ac-elfhgej-shard-00-02.ymufszp.mongodb.net:27017/?ssl=true&replicaSet=atlas-sbs9e1-shard-0&authSource=admin&retryWrites=true&w=majority")
    db = client[stockDB]
    return db
